...
const DearSection = () => {
    return (
        <section className={'dear'}>
            <div className="container dear__container">
                <div className="dear__wrapper">
                    <h2 className="dear__h2">Дорогие участники и посетители выставки HIT Expo 2023</h2>
                    <div className="dear__txt">
                        <div className="dear__text">Отличные новости! Мы сотрудничаем с несколькими отелями, которые готовы предложить вам особую выгоду. При бронировании проживания в этих отелях, упомяните название нашей выставки, и вы получите эксклюзивную скидку.</div>
                        <p className="dear__p">Это прекрасная возможность сэкономить на вашем проживании во время выставки. Отели будут проверять список участников и посетителей, чтобы удостовериться, что вы являетесь частью нашего события, и предоставят вам специальную цену.</p>
                    </div>
