        ...
        <div className={'hotel'}>
            <div className="hotel__container container ">
                ...
                <div className="hotel__block">
                    <div className="hotel__txt">Мы уверены, что вам понравится выбор отелей-партнеров, и вы найдете подходящий вариант размещения. Насладитесь комфортом и высоким уровнем обслуживания, предлагаемыми нашими партнерами.</div>
                    <h3 className="hotel__h3">Воспользуйтесь этой привилегией. Бронируйте прямо сейчас, чтобы воспользоваться специальными условиями!</h3>
                </div>
