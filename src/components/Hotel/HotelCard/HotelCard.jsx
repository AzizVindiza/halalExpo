        ...
        <div className={'hotelCard'}>
            <div className="hotelCard__wrapper">
                <div className="hotelCard__row row2">
                    <h3 className="hotelCard__h3">Отель “Silence”</h3>
                ...
                <div className="hotelCard__pic">
                    <img src={va} className={'hotelCard__img'} alt=""/>
                </div>
                <div className="hotelCard__box">
                    ...
                    <ul className="hotelCard__ul">
                        <li className="hotelCard__li">Мы находимся в старом советском пансионате,вокруг дикая местность и уединение...</li>
                        <li className="hotelCard__li">Концепция отеля Silence "Тишина"</li>
                        <li className="hotelCard__li">Для тех кто хочет сбежать от шума и суеты !</li>
                        <li className="hotelCard__li"> Своего рода Digital detox! Для тех кто устал на работе 24/7</li>
                    </ul>
