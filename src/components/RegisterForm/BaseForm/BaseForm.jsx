                        ...
                        <div className="baseForm__popup">
                            ...
                            <div className="baseForm__wrapper">
                                ...
                                <ul className="baseForm__array">
                                    {
                                        arr.map((item, i) => (
                                            <li onClick={() => clickOnCategory(item, i)}
                                                className={`baseForm__item ${category === i ? "baseForm__item_active" : ''}`}>{item}</li>
                                        ))
                                    }
                                </ul>
                                ...
                                <h2 className="baseForm__h2">Регистрация {select === "Посетитель" ? "Посетителя" : select === "Участник" ? "Участника" : select === "Эксперт" ? "Эксперта" : select === "СМИ" ? "СМИ" :
                                    <h2 className={'baseForm__gos'}>{select === "Представитель государственных органов" ? "Представителя государственных органов" : ""}</h2>}</h2>
                                ...
                                <p className="baseForm__p">
                                    ...
                                    been the industry's standard dummy text ever since the 1500s, when Lorem Ipsum is
                                ...
                                <form onSubmit={handleSubmit(onSubmit)} className="baseForm__form">
                                    ...
                                    <div>
                                        <div className="baseForm__passport">
                                            <span className="baseForm__text">Загрузите паспорт с лицевой стороны<span
                                                className="baseForm__span">*</span></span>
                                            <div className="baseForm__download">
                                                ...
                                                <div className="baseForm__line">
                                                    <svg width="12" height="15" viewBox="0 0 12 15" fill="none"
                                                         xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                            d="M6.80554 1C6.80554 0.585786 6.46976 0.25 6.05554 0.25C5.64133 0.25 5.30554 0.585786 5.30554 1H6.80554ZM5.52521 11.6414C5.81811 11.9343 6.29298 11.9343 6.58587 11.6414L11.3588 6.86847C11.6517 6.57558 11.6517 6.1007 11.3588 5.80781C11.0659 5.51492 10.5911 5.51492 10.2982 5.80781L6.05554 10.0505L1.8129 5.80781C1.52001 5.51492 1.04513 5.51492 0.752241 5.80781C0.459348 6.1007 0.459348 6.57558 0.752241 6.86847L5.52521 11.6414ZM5.30554 1L5.30554 11.1111H6.80554L6.80554 1H5.30554Z"
                                                            fill="#3378C9"/>
                                                        <path d="M1 14H11.1111" stroke="#3378C9" strokeWidth="1.5"
                                        ...
                                        <div className="baseForm__passport2">
                                            <span className="baseForm__text">Загрузите паспорт с обратной стороны<span
                                                className="baseForm__span">*</span></span>
                                            <div className="baseForm__download">
                                                <h3 className="baseForm__h3">Загрузить</h3>
                                                <div className="baseForm__line">
                                        ...
                                        <div className="baseForm__self">
                                            <span className="baseForm__text">Сделайте селфи с паспортом<span
                                                className="baseForm__span">*</span></span>
                                            <div className="baseForm__download">
                                                <h3 className="baseForm__h3">Загрузить</h3>
                                                <div className="baseForm__line">
                                    ...
                                    <label className='baseForm__label' htmlFor="">
                                        ...
                                        <PhoneInput
                                            ...
                                            country={"eg"} enableSearch={true} className={"baseForm__number"}
                                            value={number} onChange={() => setNumber(number)}/>
                                    ...
                                    <label className='baseForm__label' htmlFor="">
                                        ...
                                        <PhoneInput
                                            ...
                                            country={"eg"} enableSearch={true} className={"baseForm__number"}
                                            value={whatsApp} onChange={() => setWatsApp(whatsApp)}/>
                                        <span> {errors.whatsApp && errors.whatsApp.message}</span>
                                    </label>

                                    {
                                        select === "СМИ" ? <MasMediaForm/> : select === "Посетитель" ? <>
                                            <EmailForm/><CheckBox/></> : select === "Участник" ? <>
                                            <Stake/><Branch/><ParticipantForm/></> : <><EmailForm/><CheckBox/></>
                                ...
                                <p className="baseForm__tp">
                                    ...
                                    соответствие с <span
                                    className="masmediaform__tp2">политикой конфиденциальности</span>
                                </p>
