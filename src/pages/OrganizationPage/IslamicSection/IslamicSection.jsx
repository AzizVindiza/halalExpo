        ...
        <div className={'islamic'}>
            <div className="container islamic__container">
                <div className="islamic__content">
                    ...
                    <div className="islamic__txt">Исламская корпорация бизнеса и инвестиции <span className={'islamic__span'}>«IBIF»</span></div>
                </div>
                <div className="islamic__text">
                    <h2 className="islamic__h2">
                        В марте 2023 года Корпорация <span className={'islamic__ib'}>IBIC</span> совместно с ассоциацией Центральной Азии  <span className={'islamic__id'}>AMECA</span> организовала и провела в Бишкеке большой международный  <span className={'islamic__id'}>Форум исламского бизнеса и инвестиций IBIF-2023</span>, в работе которого приняли участие 380 предпринимателей, представителей органов исполнительной и законодательной власти, бизнеса, инвестиционных компаний и банковских организаций.
                    </h2>
