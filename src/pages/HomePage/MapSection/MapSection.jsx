        ...
        <motion.section initial={"hidden"} whileInView={"visible"} className="map">
            ...
            <div className="map__container container">
                <motion.div  custom={2} variants={textMotion} className="map__tabs">
                    <Location h2={"Локация №1: ​с. Бактуу-Долоноту, Иссык-Кульский район, Иссык-Кульская область"} p={ "На пространстве недействующего аэропорта, развернется главная сцена Halal Investment and Trade Expo 2023. Данная локация станет центром выставки, где будут представлены инвестиционные проекты, товары, услуги и проекты местных и зарубежных компаний."}/>
                    <Location h2={"Локация №2: Государственная резиденция №2, г. Чолпон-Ата"} p={ "Это значимое место станет достойной площадкой для официальной церемонии открытия Halal Investment and Trade Expo 2023. Статус и изысканный интерьер государственной резиденции подчеркнут престиж и важность проводимого мероприятия."}/>
                </motion.div>
