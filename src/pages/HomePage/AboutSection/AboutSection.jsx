        ...
        <motion.section viewport={{amount:0.2, once:true}} initial={"hidden"} whileInView={"visible"} className="about">
            <motion.div custom={1} variants={textMotion}   className="container_fluid about__container">
                ...
                <p className="about__p">
                    ...
                    халяльных инвестиционных и инфраструктурных проектов в Кыргызстане,
                    проводимая в рамках развития международных торговых отношений и экспорта.
                    Мероприятие объединяет профессионалов из разных секторов, демонстрирует последние тенденции и инновации,
                    а также предоставляет платформу для взаимодействия экспонентов и посетителей. Выставка включает семинары, встречи и культурные мероприятия, а также специальный раздел для продуктов халяль-индустрии.
                    <br/>
                    <br/>
