...
const ZoneCard = () => {
    return (
        <section className={"zoneCard"}>
         ...
         <ZoneCardSmall item={{pic:food,name:"Food Zone",time:"Дни: 29-30 июля",participant:"50+ участников",li:["Все условия для приготовления","Участие “HIT EXPO AWARDS”","Презентация авторских блюд","Дегустация блюд”","Эскпертное мнение в области HoReCa","Возможность получение сертификации от Центра Халяль SFDA"]}}/>
