                   ...
                   <div className="connectionSection__box">
                       <div className="connectionSection__block">
                           <div className="connectionSection__oval">
                               <svg className={'connectionSection__svg'} width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                       ...
                       <div className="connectionSection__block">
                           <div className="connectionSection__oval">
                               <svg className={'connectionSection__svg'} width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
